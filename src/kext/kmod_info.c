...
#ifdef RTW88_AIRPORT_LEGACY
KMOD_EXPLICIT_DECL(com.rtw88.airport.legacy, "1.2.0", _start, _stop)
#elif defined(RTW88_AIRPORT)
KMOD_EXPLICIT_DECL(com.rtw88.airport, "1.2.0", _start, _stop)
#else
