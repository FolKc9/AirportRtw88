//
//  RTW88AirportSkywalkInterface.hpp
//  AirportItlwm-Sonoma
//
...
#ifndef RTW88AirportSkywalkInterface_hpp
#define RTW88AirportSkywalkInterface_hpp

#include <Airport/Apple80211.h>

class RTW88PCIDevice;

class RTW88AirportSkywalkInterface : public IO80211InfraProtocol {
    OSDeclareDefaultStructors(RTW88AirportSkywalkInterface)
...
private:
    RTW88PCIDevice *instance;
    uint8_t scanCache[4096] = {};
    uint32_t scanLength = 0;
    uint32_t scanOffset = 4;
    u_int32_t current_authtype_lower = 0;
    u_int32_t current_authtype_upper = 0;
};


#endif /* RTW88AirportSkywalkInterface_hpp */
